...
class CommentsController extends AbstractController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($q){
            $comments = array_filter($comments, function ($comments) use ($q){
                return stripos($comments['comment'], $q) !== false;
            });
        }



        return $this->render('admin/comments/index.html.twig', ['comments' => $comments,]);
    }
}
